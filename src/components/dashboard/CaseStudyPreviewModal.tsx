...
import { X, Eye, FileText, CheckCircle2, Copy, UploadCloud, ExternalLink, MessageSquare, TrendingUp, Layout } from "lucide-react";
...
export function CaseStudyPreviewModal({ isOpen, onClose, caseStudy, onPushToHubSpot }: CaseStudyPreviewModalProps) {
  ...
  const copyLink = () => {
    ...
    // Track usage (Fire and forget to keep UI snappy)
      ...
      <div className="bg-[#111111] border border-white/10 rounded-2xl shadow-2xl w-full max-w-2xl mx-4 animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">View public-facing data</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            {caseStudy.status === "live" && onPushToHubSpot && (
              <button
        ...
        <div className="overflow-y-auto p-6 space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight px-4 leading-tight">
              {caseStudy.headline || `${caseStudy.company_name} Success Story`}
            </h1>
            ...
            <div className="flex items-center justify-center gap-2">
               <span className={`px-2.5 py-1 text-xs font-bold uppercase tracking-wider rounded border ${
                    ...
                    caseStudy.status === 'pending' ? 'bg-orange-500/10 text-orange-400 border-orange-500/20' :
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
             ...
             {/* Metric 3: Pipeline / Deals Influenced */}
             <div className="bg-[#1A1A1A] border border-white/5 p-5 rounded-xl flex flex-col items-center justify-center text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="p-3 rounded-xl bg-white/5 border border-white/5 flex items-start gap-3 group hover:bg-white/10 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500 leading-normal">
                    Drop the public link into your cold outreach or follow-up sequences to build trust.
                  </p>
                </div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-white/5 border border-white/5 flex items-start gap-3 group hover:bg-white/10 transition-colors">
                ...
                <div>
                  <h4 className="text-[11px] font-bold text-purple-400 uppercase tracking-wider mb-1">Client Closing</h4>
                  <p className="text-xs text-zinc-500 leading-normal">
                    Show this preview during sales calls when prospects ask for "relevant experience".
                  </p>
                </div>
              </div>
            </div>
